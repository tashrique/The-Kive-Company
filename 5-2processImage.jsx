{
    ...
    function resize() {
        ...
        if (docWidth <= docHeight) {
            doc.resizeImage(UnitValue(960, "px"), null, doc.resolution, ResampleMethod.BICUBIC);
        } else {
            doc.resizeImage(null, UnitValue(960, "px"), doc.resolution, ResampleMethod.BICUBIC);
        }
